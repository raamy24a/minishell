...
/*   Updated: 2025/12/12 16:31:59 by radib            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	exec_builtin(int x, char **command, t_env *env)
{
	...
	temp = NULL;
	if (x == 1)
		return (echobuiltin(command, env, 1, 0));
	if (x == 2)
		return (call_pwd());
	if (x == 3)
...
{
	if (ft_strcmp(builtin_str, "echo"))
		return (1);
	if (ft_strcmp(builtin_str, "PWD"))
		return (2);
	if (ft_strcmp(builtin_str, "export"))
		return (3);
	if (ft_strcmp(builtin_str, "unset"))
		return (4);
	if (ft_strcmp(builtin_str, "cd"))
		return (5);
	if (ft_strcmp(builtin_str, "exit"))
		return (6);
	return (0);
}
